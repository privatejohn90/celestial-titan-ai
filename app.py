# ==========================================================
# 💠 Celestial Titan God AI v70.0 — Cloud Infinity Build
# ==========================================================
# Evolution from v67.3 — Cloud-stable, JSON-safe, duplicate-free UI
# ==========================================================
...
# ---------- CONFIG ----------
st.sidebar.title("💠 Celestial Titan God AI v70.0")
st.sidebar.caption("☁️ Cloud Infinity Build | Stable JSON Memory Engine")
...
["🏠 Dashboard","🎯 Lottery Systems","⚡ Quad & Triple Alerts","🔮 Major Games","💬 Titan Chat","🧠 Titan Memory"], key="nav_select")
...
if nav == "🏠 Dashboard":
    ...
    c2.metric("Version","v70.0","Cloud Infinity Build")
    ...
    st.caption("Titan auto-saves every generated draw + pushes live alerts to Titan Chat.")
...
# ==========================================================
    ...
    game = st.selectbox("🎮 Select Game Type", ["Pick 3","Pick 4","Pick 5"], key="game_type_v70")
    region = st.selectbox("🌍 Select Region",
        ["AZ","AR","CA","CO","CT","DE","FL","GA","ID","IL","IN","IA","KS","KY","LA","MD","MA",
         "MI","MN","MS","MO","MT","NE","NJ","NM","NY","NC","OH","OK","OR","PA","SC","TN","TX",
         "VA","WA","DC","WV","WI"], key="region_v70")
    draw_time = st.radio("🕓 Draw Time", ["Midday","Evening","Auto Detect (Random)"], key="draw_time_v70")
    ...
    if game == "Pick 5" and region not in PICK5_STATES:
        st.info(f"ℹ️ {region} does not officially host Pick-5 — Titan running simulation mode for learning.")
    ...
    if acc > 90:
        titan_send(f"High {game} accuracy {acc}% for {region} — cosmic resonance strong.", "alert")
...
# ==========================================================
    ...
    st.title("⚡ Quad & Triple Alert System — Precision Tracker")
    alert = st.selectbox("🔮 Alert Type",
        ["Pick 3 (Triple)","Pick 4 (Quad)","Pick 4 (Triple)","Pick 5 (Quad)","Pick 5 (Triple)"], key="alert_v70")
    line()
...
# ==========================================================
    ...
    g = st.selectbox("🎰 Game",["Fantasy 5","SuperLotto Plus","Mega Millions","Powerball"], key="major_v70")
    line()
...
# ==========================================================
    ...
    st.markdown("> 🗣 Titan: Systems online. Cosmic resonance synced. Awaiting next lunar phase signal...")
